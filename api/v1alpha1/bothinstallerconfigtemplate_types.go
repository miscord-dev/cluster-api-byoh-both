...
type BothInstallerConfigTemplate struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   BothInstallerConfigTemplateSpec   `json:"spec,omitempty"`
	Status BothInstallerConfigTemplateStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// BothInstallerConfigTemplateList contains a list of BothInstallerConfigTemplate
type BothInstallerConfigTemplateList struct {
	metav1.TypeMeta `json:",inline"`
...
func init() {
	SchemeBuilder.Register(&BothInstallerConfigTemplate{}, &BothInstallerConfigTemplateList{})
}
